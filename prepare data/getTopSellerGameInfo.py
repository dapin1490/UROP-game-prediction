...
# 게임 아이디 csv 불러오기
gameID = pd.read_csv("../UROP-game-prediction/prepare data/data/topSellerGameID.csv")
gameName = []  # 게임 이름
gameDates = []  # 출시 일자
prices = []  # 가격
devs = []  # 개발자
...
for i in range(0, total_num_of_games):  # 게임 아이디 수만큼 반복
    # steam 크롤링
    ...
    games.to_csv("../UROP-game-prediction/prepare data/data/topSellerGames.csv")
